...
export default function ProjectsLibaryRoute() {
  return (
    <main>
      <CoverImage
        src="/drømmeland/thumbnail.webp"
        colorScheme="drømmeland-scheme"
      />
      <div className="gutter project-section drømmeland-scheme">
        <StandaloneParagraph
          textSection={
            <>
              <h1 className="heading-large">Drømmeland</h1>
              <p className="text-medium">
                Drømmeland er en læringsapp for barn mellom 7 og 9 år. Appen
                underviser om bærekraft gjennom virituelle aktiviteter som
                resirkulering og havrydding.
              </p>
            </>
          }
        />
          ...
          textSection={
            <>
              ...
              <p>
                ...
                lærerplattform. Barna kan løse bærekraftsutfordringer og tjene
                poeng, noe som kombinerer læring med lek. For å sikre relevans
                og engasjement ble det gjennomført kvalitative undersøkelser,
                inkludert observasjoner og intervjuer med barn i målgruppen.
              </p>
            </>
          }
        />
        ...
        <ParagraphWithImage
          textSection={
            <div>
              ...
              <p>
                Konseptet for Drømmeland kombinerer læring og lek ved å tilby
                barn en interaktiv plattform der de kan utføre oppdrag, som
                virtuell resirkulering og havrydding. Gjennom oppgavene får
                barna praktisk innsikt i bærekraftige handlinger, samtidig som
                det er gøy. For å skape et univers som appellerer til
                målgruppen, utviklet vi personas og brukerhistorier som styrte
                designprosessen. Dette bidro til å forme et grensesnitt som er
                både lærerik og underholdende.
              </p>
            </div>
          }
        ...
        <StandaloneParagraph
          textSection={
            <>
              ...
              <p>
                Prototypen for Drømmeland ble utformet med barnas perspektiv i
                sentrum. Vi holdt workshops der vi inviterte barn til å bidra
                med ideer til spilluniverset og avatarene. Workshopene
                inkluderte semistrukturerte intervjuer og samskaping, hvor barna
                deltok i tegneoppgaver som &quot;tegn et kult spillunivers&quot;
                og &quot;tegn din drømmeavatar.&quot; Disse tegningene
                inspirerte designet og gjorde prototypen målgruppetilpasset.
                Resultatet er en engasjerende og fargerik prototype som
                reflekterer barnas egne idéer og preferanser.
              </p>
            </>
          }
        />
