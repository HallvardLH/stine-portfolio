            ...
            <main>
                <div className="text-section shortened-paragraph">
                    ...
                    <p className="text-medium">
                        Jeg er alltid interessert i spennende prosjekter som trenger UX-kompetanse. Ta kontakt om du vil diskutere idéer, forbedre brukeropplevelsen eller utforske hvordan design kan løse reelle behov.
                    </p>
                </div>
