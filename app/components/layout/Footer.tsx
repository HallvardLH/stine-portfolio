  ...
  return (
    <footer className="footer-container">
      <nav>
        <h2
          className={
            "text-large " + (colorScheme ? colorScheme : "heading-normal-color")
          }
        >
          Navigasjon
        </h2>
      ...
      <div className="footer-contacts-and-socials">
        <div>
          <h2
            className={
              "text-large " +
              (colorScheme ? colorScheme : "heading-normal-color")
            }
          >
            Kontaktinfo
          </h2>
        ...
        <div className="socials-container">
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.linkedin.com/in/stine-knutsen-77b311294"
          >
            <img src={"/icons/linkedin.svg"} alt="" className="socials-icon" />
          </a>
        </div>
      </div>
      ...
      <div className="footer-credit-container">
        ...
        <p style={{ fontWeight: "lighter" }}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            href="https://hallvardlh.netlify.app/"
          >
            Hallvard Lygre Hetlelid
          </a>
        </p>
      </div>
    </footer>
